...
export const homePageMeta: HomepageMeta = {
  ...
  description:
    "Voici une courte présentation de mon savoir-faire et de mes compétences",
};
  ...
  description: (
    <>
      <p className='prose-sm text-stone-200 sm:prose-base lg:prose-lg'>
        Altruiste au coeur de feu, je me bats avec le sourire pour atteindre des
        résultats. Imaginant tout les scénarios possibles avec une volonté de
        vouloir expérimenter. Voilà pourquoi être{" "}
        <strong>Développeur web</strong> me passionne!
      </p>
    </>
  ),
  actions: [
...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    description:
      "Ce troisième projet d’Openclassrooms m’a fait comprendre l’importance du SEO (référencement naturel) On nous fournissait le code source du site monté sur CMS (wordpress) Un audit a été effectué pour comprendre les améliorations à mettre en place.",
  ...
  },
  {
    title: "Booki",
    description:
      "Le but de ce premier projet Openclassrooms consistait à intégrer les maquettes fournis aux format desktop tablette et mobile. Language Utilisé HTML/CSS.",
  ...
  },
  {
    title: "Ohmyfood",
    description:
      "Dans ce second projet Openclassrooms l’intégration de la maquette devait se faire en Mobile-first. L’adaptation desktop et tablette n’était pas exigé. Language utilisé HTML/CSS grâce aux outils SASS et Git.",
...
export const education: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        Grâce à OpenClassRooms j'ai appris à développer des éléments de
        l'interface d'un site web grâce à des composants React
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Optention d'un Brevet Professionel en alternance dans l'entreprise
        Climat-Sol
      </p>
    ),
    date: "Decembre 2007",
...
export const experience: TimelineItem[] = [
  {
    location: "Clauger",
    title: "Technicien d'intervention ",
    date: "2023-04-03 à Aujourd'hui",
    content: <p>Le Thor, France</p>,
  },
  {
    location: "Froid Palombi",
    title: "Dépanneur frigoriste ",
    date: "2023-04-03 à 2024-03-01",
...
export const contact: ContactSection = {
  ...
  description:
    "C'est vrai que l'on pourrais s'écrire des lettres mais ça marche pas encore. Il va falloir attendre un peu...",
  items: [
    {
...
export const socialLinks: Social[] = [
  ...
  { label: "Stack Overflow", Icon: StackOverflowIcon, href: "" },
  {
    label: "LinkedIn",
    Icon: LinkedInIcon,
    href: "https://www.linkedin.com/in/guillaume-d-b30929107/",
  },
  {
    label: "Instagram",
    Icon: InstagramIcon,
  ...
  },
  {
    label: "Twitter",
    Icon: TwitterIcon,
    href: "https://twitter.com/Guillaumeluhang",
  },
];
